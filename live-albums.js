...
(function(){
const albums=[
{title:'LIVE AT SEA',sub:'Cocktails • Steelpan • Caribbean Lounge',src:'assets/Gorilla_Boomin_Live_At_Sea_WEB.mp3',tracks:[['00:00','Port of Viarruel (Jazz Intro)',0],['00:51','Summertime',51],['10:39','Stir It Up',639],['13:26','Jammin’',806],['18:35','Is This Love',1115],['27:49','Waiting in Vain — Lounge Version',1669]]},
{title:'POOLSIDE IN PARADISE',sub:'Live Caribbean Cruise Sessions',src:'assets/Gorilla_Boomin_Poolside_In_Paradise_WEB.mp3',tracks:[['00:00','Jammin’ — Poolside Version',0],['03:19','Margaritaville',199],['07:29','Brown Eyed Girl',449],['11:49','No Woman, No Cry',709],['13:42','Waiting in Vain',822],['18:21','Sweat (A La La La La Long)',1101],['23:06','Red Red Wine',1386]]}
];
function build(){
 ...
 albums.forEach((a,ai)=>{
  ...
  card.innerHTML='<div class="album-cover"><div class="album-badge">LIVE ARCHIVE 0'+(ai+1)+'</div><div class="album-cover-copy"><small>GORILLA BOOMIN</small><strong>'+a.title+'</strong><span>'+a.sub+'</span></div></div><div class="album-body"><div class="album-head"><div><small>LIVE ALBUM</small><h3>'+a.title+'</h3><p>'+a.sub+'</p></div><button class="album-play" type="button">▶ PLAY</button></div><audio preload="metadata" src="'+a.src+'"></audio><div class="album-progress"><span class="cur">0:00</span><input type="range" min="0" max="100" value="0" step="0.1"><span class="dur">--:--</span></div><div class="tracklist"></div></div>';
